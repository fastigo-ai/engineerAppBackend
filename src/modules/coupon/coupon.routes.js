...
router.put('/admin/update/:couponId', authorize('admin', 'super_admin'), couponController.adminUpdateCoupon);
router.delete('/admin/delete/:couponId', authorize('admin', 'super_admin'), couponController.adminDeleteCoupon);
